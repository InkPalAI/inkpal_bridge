...
class InkPalBridge {
  ...
  static void init({
    ...
    // WebSocket — bidirectional channel. Commands IN, telemetry OUT.
    ...
    bridge._wsField = ReconnectingWebSocket(
      ...
      onConnect: () => InkPalWelcomeConsole.instance.onClientConnected(),
      onDisconnect: () => InkPalWelcomeConsole.instance.onClientDisconnected(),
    );
